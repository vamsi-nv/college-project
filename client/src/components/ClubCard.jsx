...
function ClubCard({ club }) {
  return (
    <div title={club.name} className="hover:bg-gray-50/50 mx-auto my-3 w-[90%] sm:w-[80%] md:w-6/7 lg:w-3/5 border border-gray-300 rounded-2xl shadow-gray-300/80 hover:shadow-[0_0_10px] hover:scale-105 transition-all duration-300 cursor-pointer">
      {club.coverImage ? (
        <img
          src={club.coverImage}
          alt={club.name}
