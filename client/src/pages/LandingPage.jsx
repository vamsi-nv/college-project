  ...
  return (
    ...
    >
      <header className="flex items-center justify-between max-w-6xl p-4 py-6 mx-auto">
        ...
        >
          <Logo className="text-blue-600 w-14" />
          <h2 className="text-2xl font-semibold text-transparent bg-gradient-to-b from-white to-blue-100 bg-clip-text">
            CSphere
          </h2>
        </motion.div>
        <motion.div
        ...
        >
          <Link to={"/register"}>
            <button className="px-3 py-2 text-white flex items-center gap-1 hover:gap-1.5 transition-all duration-300 rounded-full shadow-sm max-sm:text-sm bg-gradient-to-r from-primary to-blue-600 hover:scale-105 shadow-blue-600/40 hover:shadow-lg hover:shadow-blue-500/30 relative">
      ...
      <main className="min-h-[calc(100vh-80px)] flex items-center justify-center flex-col ">
        ...
        >
          <h1 className="max-w-6xl mb-10 text-4xl text-center md:text-6xl leading-18">
        ...
        >
          <Link to={"/login"}>
            <button className="px-6 py-2 font-medium text-white transition-all duration-300 rounded-full shadow-sm hover:scale-105 bg-gradient-to-r from-primary to-blue-600 shadow-blue-600/40 hover:shadow-md hover:shadow-blue-600/30">
              Login
            </button>
          </Link>

          <Link to={"/register"}>
            <button className="px-5 py-2 font-medium transition-all rounded-full shadow-sm bg-primary/20 outline-2 text-primary outline-primary hover:bg-gradient-to-r from-primary to-blue-600 hover:text-white hover:outline-none">
              Sign Up
            </button>
          </Link>
        </motion.div>
